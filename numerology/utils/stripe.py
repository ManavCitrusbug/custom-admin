...
class MyStripe():
    ...
    def create_card(self, customer_id, data):
        """Using this method you can create a new card of existing customer"""
        return stripe.Customer.create_source(customer_id, source=data['card_id'])
    ...
    def create_charge(self, data, card, customer_id):
        ...
        return stripe.Charge.create(amount=int(data["total_amount"]), currency=settings.CURRENCY, source=card, customer=customer_id)
